...
front_standing = pygame.image.load('animation/caliph1/caliph_front_walk.001.bmp')
back_standing = pygame.image.load('animation/caliph1/caliph_front_walk.001.bmp')
left_standing = pygame.image.load('animation/caliph1/caliph_front_walk.001.bmp')
...
animTypes = 'front_walk'.split()
animObjs = {}
for animType in animTypes:
    imagesAndDurations = [('animation/caliph1/caliph_%s.%s.bmp' % (animType, str(num).rjust(3, '0')), 0.1) for num in range(6)]
    animObjs[animType] = pyganim.PygAnimation(imagesAndDurations)

# create the right-facing sprites by copying and flipping the left-facing sprites
animObjs['right_walk'] = animObjs['front_walk'].getCopy()
...
"""
    ...
    pygame.display.update()
    mainClock.tick(3) # Feel free to experiment with any FPS setting.
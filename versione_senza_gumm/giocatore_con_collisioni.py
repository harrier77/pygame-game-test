...
class giocatore_con_collisioni(giocatore_base):
	...
	def is_walkable(self):
		...
		if coll_layer.content2D[tile_y][tile_x]:
			return False
		elif coll_layer.content2D[tile_y+1][tile_x]:
			return False
		elif coll_layer.content2D[tile_y+1][tile_x+1]:
			return False
		elif coll_layer.content2D[tile_y+1][tile_x+2]:
			return False
		else:
			return True
		"""

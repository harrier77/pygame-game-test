...
def apri_mappa(nomefile,screen_width,screen_height):
	print nomefile
	dir='..\\tmwa\\maps\\'
	#self.ripristina_menu()
	oggetto_map_hero=App_gum(resolution=(screen_width,screen_height),dir=dir,mappa=nomefile,ign_coll=True)
...
def main():
	...
	for fname in lista_immagini:
		...
		mia_immagine.connect(gui.CLICK, apri_mappa, nome_tmx,screen_width,screen_height) 

...
__version__ = '$Id: 07_tiled_map_with_renderer.py 433 2014-03-21 03:39:35Z stabbingfinger@gmail.com $'
...
class App(Engine):
    ...
    def __init__(self, resolution=(640,480)):
        ...
        Engine.__init__(self,
            caption='Movimenti mouse',
            resolution=resolution,
            #camera_target=Avatar((325,420), resolution//2),
            camera_target=Cinghiale((325,420), resolution//2),
            map=tiled_map,
            frame_speed=0)

        #miocing=Cinghiale((325,420), resolution//2)
    ...
    def calcola_passi(self,target_pos=(200,200)):
        or_x,or_y= self.camera.target.screen_position
        distanza=int(geometry.distance((or_x,or_y),target_pos))
        lista_posizioni=[]
        for progress_distance in range(1,distanza):  
                p= geometry.step_toward_point((or_x,or_y), target_pos, progress_distance)
                #print p
    ...
    def update(self, dt):
        ...
        # If mouse button is held down update for continuous walking.
         #self.auto_update(State.camera.target.elenco_posizioni[0])
        if self.mouse_down:
    ...
    def on_key_down(self, unicode, key, mod):
        ...
        if key == K_F4:
            print 'f4'
            listap=self.calcola_passi()
            print listap
            for pos in listap:
                self.camera.target.screen_position=pos
